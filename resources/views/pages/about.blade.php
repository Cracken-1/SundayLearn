    ...
    <div class="container">
        <div style="max-width: 900px; margin: 0 auto;">
                ...
                <div style="display: grid; gap: 1.5rem;">
                    ...
                    <div style="display: flex; gap: 1rem;">
                        ...
                        <div>
                            ...
                            <p style="color: var(--text-light); line-height: 1.6;">
                                Lessons designed specifically for different age groups (Class A: {{ config('site.age_groups.A') }}, Class B: {{ config('site.age_groups.B') }}, Class C: {{ config('site.age_groups.C') }}, and {{ config('site.age_groups.D') }}) with appropriate language and concepts.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div style="background: var(--background-white); padding: 3rem; border-radius: 10px; box-shadow: var(--shadow-light); margin-bottom: 2rem;">
                ...
                <p style="line-height: 1.8;">
                    Today, Friends of Children Ministries serves teachers in churches of all sizes, helping them spend less time preparing and more time connecting with their students.
                </p>
            </div>
